...
app/                    --> all of the source files for the application
  ...
  resource
	userResource.js				 --> Load resource from git API
  view1/                --> All availble users list
    view1.html            --> the partial template
    view1.js              --> the controller logic
    view1_test.js         --> tests of the controller
  view2/                --> Search users / view all availble repositories of current user
...
[Jasmine][jasmine], which we run with the [Karma Test Runner][karma]. Providing a Karma
